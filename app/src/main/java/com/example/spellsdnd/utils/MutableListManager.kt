...
//    fun saveFavoritesToPrefs(context: Context, favoritesSpells: MutableList<MutableList<SpellDetail>>) {
...
//    fun loadFavoritesFromPrefs(context: Context): MutableList<MutableList<SpellDetail>> {
//        val sharedPrefs: SharedPreferences = context.getSharedPreferences(
//            FAVORITES_PREFS_KEY, Context.MODE_PRIVATE
//        )
...
//            try {
//                Gson().fromJson(serializedFavorites, object : TypeToken<MutableList<MutableList<SpellDetail>>>() {}.type)
//            } catch (e: Exception) {
//                mutableListOf<MutableList<SpellDetail>>()
//            }
//        } else {
//            mutableListOf()
//        }
